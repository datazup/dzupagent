...
import type { AdapterTracerConfig, SpanEvent, TraceContext, TraceSpan } from './trace-types.js'
export type { AdapterTracerConfig, SpanEvent, TraceContext, TraceSpan } from './trace-types.js'
