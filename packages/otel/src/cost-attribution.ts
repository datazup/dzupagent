 ...
 *
 * Subscribes to ForgeEventBus for cost-related events and maintains
...
export class CostAttributor {
  ...
  private _eventBus: ForgeEventBus | undefined
  ...
  /**
   * Subscribe to ForgeEventBus for cost-related events.
   */
