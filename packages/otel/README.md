...
sink.getHistogram('dzip_agent_duration_seconds', { agent_id: 'code-gen' })
...
- `dzip_agent_duration_seconds` (histogram) -- agent run duration
- `dzip_agent_errors_total` (counter) -- agent failures by error code
