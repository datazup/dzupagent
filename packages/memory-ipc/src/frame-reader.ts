 ...
 * and conversion back to DzupAgent record format.
 *
 ...
 *
 * Provides typed column access, filtering, and reconstruction of DzupAgent
 * convention fields.
 */
export class FrameReader {
  ...
  /**
   * Convert all rows back to DzupAgent record format.
   *
