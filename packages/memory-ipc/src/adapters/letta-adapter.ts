 ...
 * @returns           Record suitable for DzupAgent WorkingMemory
 */
...
/**
 * Convert a DzupAgent WorkingMemory record to Letta core memory blocks.
 *
 ...
 * are truncated.
 *
 * @param workingMemory  DzupAgent WorkingMemory state
