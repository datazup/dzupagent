...
const PUBLIC_NODE_KIND_FIXTURES: Record<FlowNode["type"], FlowNode> = {
  ...
  "spdd.import_sources": {
    ...
    sourceRefs: [{ repo: "repo-a", path: "src" }],
  ...
  "spdd.project_plan": {
    ...
    spddRunId: "spdd-run-1",
    promptAssetVersionId: "prompt-plan-v1",
    outputKey: "projectPlan",
  },
  "spdd.scan_drift": {
    type: "spdd.scan_drift",
    spddRunId: "spdd-run-1",
    promptAssetVersionId: "prompt-drift-v1",
    outputKey: "driftScan",
  },
  "spdd.run_analysis": {
    ...
    sourceArtifactIds: ["source-pack-1"],
    outputKey: "analysis",
  },
  "spdd.generate_canvas": {
    type: "spdd.generate_canvas",
    spddRunId: "spdd-run-1",
    promptAssetVersionId: "prompt-canvas-v1",
    outputKey: "canvas",
    title: "MVP Canvas",
    objective: "Stabilize fragment MVP",
  },
  "spdd.validate_canvas": {
    type: "spdd.validate_canvas",
    spddRunId: "spdd-run-1",
    promptAssetVersionId: "prompt-validate-v1",
    outputKey: "canvasValidation",
  },
  "spdd.review_canvas": {
    type: "spdd.review_canvas",
    spddRunId: "spdd-run-1",
    promptAssetVersionId: "prompt-review-v1",
