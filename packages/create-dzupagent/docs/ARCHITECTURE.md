...
## Purpose
`create-dzupagent` is a CLI scaffolding package that generates DzupAgent projects from bundled template manifests. It provides both command-line and programmatic interfaces for bootstrapping opinionated project structures.
...
## Main Features
- Five built-in starter templates targeting common DzupAgent setups.
...
- Intended as entrypoint for new projects that later consume DzupAgent workspace packages.
