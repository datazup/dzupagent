 ...
 *
 * @experimental No production consumer exists for this surface as of the
 * 2026-08-27 architecture audit (ARCH27-N-15); it is exported for
 * compatibility only and may be reshaped or removed.
 *
...
export function createCodeReviewPipeline(
  ...
  return {
    ...
    schemaVersion: "1.0.0",
    description:
      "Automated code review: load diff, analyze, review, quality gate, report.",
    ...
    edges: [
      ...
      { type: "sequential", sourceNodeId: "analyze", targetNodeId: "review" },
      {
        type: "sequential",
        sourceNodeId: "review",
        targetNodeId: "quality-gate",
      },
      {
        type: "sequential",
        sourceNodeId: "quality-gate",
        targetNodeId: "report",
      },
...
export function createFeatureGenerationPipeline(
  ...
  return {
    ...
    schemaVersion: "1.0.0",
    description:
      "End-to-end feature generation: plan, generate, validate, fix loop, review, approve, publish.",
    entryNodeId: "plan",
    budgetLimitCents,
    checkpointStrategy: "after_each_node",
...
export function createTestGenerationPipeline(
  ...
  return {
    ...
    nodes: [
      {
        ...
        name: "Analyze Code",
        description:
          "Analyze the source code to identify testable units and edge cases.",
      ...
      },
      {
        ...
        name: "Generate Tests",
        description:
          "Generate test files covering unit, integration, and edge cases.",
        agentId: "test-writer",
        config: { framework },
        timeoutMs: 300_000,
      },
    ...
    edges: [
      {
        type: "sequential",
        sourceNodeId: "analyze-code",
        targetNodeId: "generate-tests",
      },
      {
        type: "sequential",
        sourceNodeId: "generate-tests",
...
export function createRefactoringPipeline(
  ...
  const nodes: PipelineDefinition["nodes"] = [
    {
      ...
      description:
        "Analyze the codebase for code smells, duplication, and improvement opportunities.",
      agentId: "code-analyzer",
      timeoutMs: 120_000,
    },
    {
  ...
  return {
    ...
    schemaVersion: "1.0.0",
    description:
      "Systematic refactoring: analyze, plan, refactor, validate, review, report.",
    entryNodeId: "analyze",
    budgetLimitCents,
    checkpointStrategy: "after_each_node",
