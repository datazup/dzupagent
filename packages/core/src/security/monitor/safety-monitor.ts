 ...
 *
 * Subscribes to ForgeEventBus and scans content on-demand using configurable
...
export function createSafetyMonitor(config?: SafetyMonitorConfig): SafetyMonitor {
  ...
  let currentBus: ForgeEventBus | undefined

  function recordViolation(violation: SafetyViolation, bus?: ForgeEventBus): void {
  ...
  function attach(eventBus: ForgeEventBus): void {
