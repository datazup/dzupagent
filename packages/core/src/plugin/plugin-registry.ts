import type { DzupPlugin, PluginContext } from './plugin-types.js'
...
export class PluginRegistry {
  private plugins = new Map<string, DzupPlugin>()
  ...
  async register(plugin: DzupPlugin, ctx: PluginContext): Promise<void> {
