/**
 * @dzupagent/core/security — Curated API facade for security, policy,
...
// ---------------------------------------------------------------------------
// Destructive Command Guard (MCP shell tool protection)
// ---------------------------------------------------------------------------
export {
  SHELL_TOOL_NAMES,
  DESTRUCTIVE_COMMAND_PATTERNS,
  assertCommandNotDestructive,
} from "../security/destructive-command-guard.js";
