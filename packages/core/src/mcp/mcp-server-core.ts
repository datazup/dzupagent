...
import { buildError, buildResult, isMCPRequest } from "./mcp-server-utils.js";
...
export class DzupAgentMCPServer {
  ...
  get advertisedProtocolVersion(): string {
  ...
  async handleRequest(request: MCPRequest): Promise<MCPResponse | null> {
    ...
    switch (method) {
      ...
      case "resources/templates/list":
        ...
        break;
      case "resources/read":
        response = await handleResourceRead(
          this.resources,
