...
export type { CheckpointManagerConfig, CheckpointErrorCode, CheckpointFailure, CheckpointEntry, CheckpointDiff, CheckpointResult, CheckpointProof, CheckpointDetailedResult, CheckpointListResult, CheckpointDiffResult, CheckpointRestoreResult, CheckpointRecoveryState, CheckpointRecoveryInspectionResult, CheckpointRecoveryAuthorization, CheckpointRecoveryResult, CheckpointCompactionResult } from './vfs/checkpoint-manager.js'
