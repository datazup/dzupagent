...
| `stable`   | `./context-eviction.js`      |            6 | `exact:./context-eviction.js`      | `evictIfNeeded`, `EvictionConfig`, `EvictionResult`, `evictWithOffload`, `OffloadSink`, `OffloadEvictionResult` |
