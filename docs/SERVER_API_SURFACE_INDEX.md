...
| `./routes/metrics.js` | `secondary` | `metrics` | `candidate-subpath` | 3 | `createMetricsRoute`, `MetricsAccessControl`, `MetricsRouteConfig` |
...
| `./runtime/tool-resolver.js` | `secondary` | `runtime` | `candidate-subpath` | 13 | `resolveAgentTools`, `ToolResolutionError`, `getToolProfileConfig`, `ToolResolverContext` |
